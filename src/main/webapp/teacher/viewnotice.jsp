...
<head>
    <meta charset="UTF-8">
    <title>View Class Notices | Teacher</title>
    ...
    <div class="home-content">
        <div class="sidenav">
            ...
            <div class="dropdown-container" style="width:15%;">
                ...
                <a href="./viewnotice.jsp" class="active"><i class="fas fa-chevron-right"></i> View Notices</a>

            </div>

            <div class="tab" style="margin-left:10%;">
                <h2 style="margin-left:10%;">Notices</h2>
                <table border="1">
                    <thead>
                    <tr>
                        <th style="background-color: #FFC300;">Notice Number</th>
                        <th style="background-color: #FFC300;">Date</th>
                        <th style="background-color: #FFC300;">Notice Details</th>
                    </tr>
                    </thead>
